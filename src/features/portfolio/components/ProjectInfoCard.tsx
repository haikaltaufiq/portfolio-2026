...
interface ProjectInfoCardProps {
  ...
  delay?: number;
  index?: number;
  children?: ReactNode; // WAJIB ADA INI BIAR GAK ERROR BJIR
}
    ...
    <SlideIn delay={delay} direction="up">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          {/* RENDER CHILDREN DI SINI BIAR GAK CUMA JADI DEFINISI DOANG BJIR */}
        ...
        <div className="mt-10 pt-6 border-t border-main-text/10">
          <button className="flex items-center justify-between w-full group/btn">
            <span className="text-[10px] uppercase tracking-[0.3em] font-black group-hover:text-[#F25623] transition-colors">
              access full report
            </span>
