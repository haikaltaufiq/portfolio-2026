    ...
    <SlideIn delay={delay} direction="up">
      ...
      >
        <motion.div
          ...
          className="relative border-2 border-main-text p-8 h-full flex flex-col justify-between group bg-main-bg overflow-hidden transition-colors duration-300"
        >
          {/* Background Grid Accent - Muncul pas hover */}
          <div className="absolute inset-0 opacity-0 group-hover:opacity-[0.03] transition-opacity duration-500 pointer-events-none bg-[grid:20px_20px] bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)]" />
          ...
          <div className="mt-10 pt-6 border-t border-main-text/10">
            <button
              ...
              className="flex items-center justify-between w-full group/btn relative overflow-hidden"
            >
              <span className="text-[10px] uppercase tracking-[0.3em] font-semibold group-hover/btn:text-[#F25623] transition-colors z-10">
                access full report
              </span>

              <div className="w-10 h-10 border-2 border-main-text rounded-none flex items-center justify-center group-hover/btn:bg-[#F25623] group-hover/btn:border-[#F25623] group-hover/btn:text-main-bg transition-all z-10">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
